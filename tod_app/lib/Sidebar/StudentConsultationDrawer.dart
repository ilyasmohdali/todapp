...
class StudentConsultationDrawer extends StatefulWidget{

  final String uid;
  StudentConsultationDrawer({this.uid});

  @override
  _StudentConsultationDrawerState createState() => new _StudentConsultationDrawerState();
}

class _StudentConsultationDrawerState extends State<StudentConsultationDrawer>{
                        ...
                        child: InkWell(
                          child: Material(
                            ...
                            child:ListTile(
                                ...
                                title: Text("Home", style: TextStyle(fontFamily: "Poppins-Bold", fontSize: 18.0),),
                                onTap: (){
