...
class FireMap2 extends StatefulWidget {

  final markerLocation, userLocation, onTap;

  const FireMap2({Key key, this.markerLocation, this.userLocation, this.onTap}):super (key:key);

  @override
  _FireMap2State createState() => _FireMap2State();
}

class _FireMap2State extends State<FireMap2> {
    ...
    return Stack(
        children: <Widget>[
          GoogleMap(
            ...
            markers: widget.markerLocation != null ? [Marker(markerId: MarkerId("Tap Location"),
