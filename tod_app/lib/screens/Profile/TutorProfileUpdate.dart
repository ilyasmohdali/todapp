...
class TutorUpdateProfile extends StatefulWidget {
  ...
  TutorUpdateProfile({this.uid,this.userName,this.email,this.phoneNum,this.userData});

  @override
  _TutorUpdateProfileState createState() => new _TutorUpdateProfileState();
}
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          if (_image != null) {
                            ...
                            await DatabaseService(uid: user.uid, file: _image).uploadImage(
                              uid ?? userData.id,
