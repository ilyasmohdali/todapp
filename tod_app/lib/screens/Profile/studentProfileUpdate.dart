...
class StudentUpdateProfile extends StatefulWidget {
  ...
  StudentUpdateProfile({this.uid,this.userName,this.email,this.phoneNum,this.userData});

  @override
  _StudentUpdateProfileState createState() => new _StudentUpdateProfileState();
}
