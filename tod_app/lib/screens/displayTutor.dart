...
class _DisplayTutorState extends State<DisplayTutor> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.userP1 == 'Video' &&
        widget.userP2 == 'default' &&
        widget.userP3 == 'default') {
                        ...
                        children: <Widget>[
                          Container(
                              padding: EdgeInsets.only(
                                  left: 20.0, top: 12.0, bottom: 10.0),
                              child: Text("List of Tutors",
                                  style: TextStyle(
                                      fontSize: 20.0, fontFamily: "Poppins"))),
                          Container(child: showAllTutorVDD())
                        ],
                      ));
            } else {
              return Wrapper();
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Text("List of Tutors",
                            style: TextStyle(
                                fontSize: 20.0, fontFamily: "Poppins"))),
                    Container(child: showAllTutorDAD())
                  ],
                ));
      }
    } else if (widget.userP1 == 'default' &&
        widget.userP2 == 'default' &&
        widget.userP3 == 'Hands-On') {
      {
        return loading
            ? Loading()
            : Scaffold(
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Text("List of Tutors",
                            style: TextStyle(
                                fontSize: 20.0, fontFamily: "Poppins"))),
                    Container(child: showAllTutorDDK())
                  ],
                ));
      }
    } else if (widget.userP1 == 'Video' &&
        widget.userP2 == 'Audio' &&
        widget.userP3 == 'default') {
          ...
          : Scaffold(
              ...
              body: ListView(
                children: <Widget>[
                  Container(
                      padding:
                          EdgeInsets.only(left: 20.0, top: 12.0, bottom: 10.0),
                      child: Text("List of Tutors",
                          style: TextStyle(
                              fontSize: 20.0, fontFamily: "Poppins"))),
                  Container(child: showAllTutorVAD())
                ],
              ));
    } else if (widget.userP1 == 'Video' &&
        widget.userP2 == 'default' &&
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Text("List of Tutors",
                            style: TextStyle(
                                fontSize: 20.0, fontFamily: "Poppins"))),
                    Container(child: showAllTutorVDK())
                  ],
                ));
      }
    } else if (widget.userP1 == 'default' &&
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Text("List of Tutors",
                            style: TextStyle(
                                fontSize: 20.0, fontFamily: "Poppins"))),
                    Container(child: showAllTutorDAK())
                  ],
                ));
      }
    } else if (widget.userP1 == 'Video' &&
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Text("List of Tutors",
                            style: TextStyle(
                                fontSize: 20.0, fontFamily: "Poppins"))),
                    Container(child: showAllTutorVAK())
                  ],
                ));
      }
    }
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: Text("List of Tutors",
                          style: TextStyle(
                              fontSize: 20.0, fontFamily: "Poppins"))),
                  Container(child: showAllTutorDDD())
                ],
              ));
    }
    /*else{
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Card(
                ...
                leading: CircleAvatar(
                    backgroundImage:
                        NetworkImage(document[index].data['imageURL'])),
                ...
                title: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(
                        alignment: Alignment.centerLeft,
                        child: Text(document[index].data['phoneNum']),
                      ),
                      SizedBox(
                        height: 3.0,
                      ),
                      Container(
                        alignment: Alignment.centerLeft,
                        child: Text(document[index].data['gender']),
                      ),
                      SizedBox(
                        height: 3.0,
                      )
                ...
                trailing: RaisedButton(
                    ...
                    child: Icon(Icons.phone_in_talk,
                        size: 20, color: Colors.black87.withOpacity(0.7))),
  ...
  showAllTutorVDD() {
    ...
    return StreamBuilder(
        stream: Firestore.instance
            .collection('users')
            .where('tutorTeach1', isEqualTo: 'Visual')
            .snapshots(),
  ...
  showAllTutorDAD() {
    ...
    return StreamBuilder(
        stream: Firestore.instance
            .collection('users')
            .where('tutorTeach2', isEqualTo: 'Auditory')
            .snapshots(),
  ...
  showAllTutorDDK() {
    ...
    return StreamBuilder(
        stream: Firestore.instance
            ...
            .where('tutorTeach3', isEqualTo: 'Kinesthetic')
            .snapshots(),
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (!snapshot.hasData) {
            return Wrapper();
